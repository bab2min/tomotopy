...
static int CT_init(TopicModelObject *self, PyObject *args, PyObject *kwargs)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|nnnnnffnsOO", (char**)kwlist, &tw, &minCnt, &minDf, &rmTop,
	...
	try
	{
		...
		tomoto::ITopicModel* inst = tomoto::ICTModel::create((tomoto::TermWeight)tw, K, alpha, eta, seed, scalarRng);
